function [phantom] = Generate_PolSAR_two_classes_phantom_rectangle(S, L, m, n, img1, rows1, cols1)
...
aux1(1:m,1:n,1) = reshape(S_class_2(1,1,:),m,n);
aux1(1:m,1:n,2) = reshape(S_class_2(2,2,:),m,n);
aux1(1:m,1:n,3) = reshape(S_class_2(3,3,:),m,n);
aux1(1:m,1:n,4) = reshape(real(S_class_2(1,2,:)),m,n);
aux1(1:m,1:n,5) = reshape(imag(S_class_2(1,2,:)),m,n);
aux1(1:m,1:n,6) = reshape(real(S_class_2(1,3,:)),m,n);
aux1(1:m,1:n,7) = reshape(imag(S_class_2(1,3,:)),m,n);
aux1(1:m,1:n,8) = reshape(real(S_class_2(2,3,:)),m,n);
aux1(1:m,1:n,9) = reshape(imag(S_class_2(2,3,:)),m,n);
L1 = length(rows1);
L2 = length(cols1);
for i= 1: L1
