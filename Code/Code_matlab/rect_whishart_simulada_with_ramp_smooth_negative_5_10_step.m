...
[bw_step, bw_strip_step, bw_entire_step] = gera_step_5_10_negativo(N, xl, xu, yl, yu, eps);
%
img1 = zeros(N);
img2 = zeros(N);
img3 = zeros(N);
...
img1_step = bw_strip_step;
% Becareful step = 0 to 1
img2_step = 1.0 - bw_step;
% Becareful step = 5 to 10
%img2 = 10.0 - bw;
img3_step = bw_entire_step - bw_strip_step;
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Inserindo a distribuiçao Wishart %%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Height = N;
Width  = N;
[phantom] = Generate_PolSAR_two_classes_phantom_rectangle_with_ramp_neg(S, L, Height, Width, img1_step, rows1, cols1, bw_step, rows2, cols2, img3_step, rows3, cols3);
...
cd Data
for canal = 1: 3
	fname = sprintf('Phantom_rectangle_ramp_smooth_mu1_less_mu2_negative_step_5_10_%d_%d.txt', canal, eps);
	fid = fopen(fname,'w');
	for i = 1: N
		for j = 1: N
