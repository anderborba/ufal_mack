...
\section{Probabilities Densities functions to intensities channels}
...
\subsection{Probability density Gamma function }
...
\subsection{Probability density univariate magnitude of product}
...
\end{split}
 \end{equation} 
%
\subsection{Probability density univariate ratio intensity}
...
\subsection{Probability density Gamma value function}
...
\subsection{Probability density magnitude of product value function}
...
\subsection{Probability density ratio intensity value function}
...
\bibliography{Refs_artigo_pdfs_fusion_2020}
\end{document}
