...
According to Mac, the methods showed excellent performance because the dataset (image) with methods results is unbalanced; that is, the number of TNs is much larger than the number of TPs, FPs, and FNs. 
