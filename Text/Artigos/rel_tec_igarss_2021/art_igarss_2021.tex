...
The quality metrics are based on the confusion matrix of the binary images, compared with the Ground Reference image (GR). 
...
where the Matthews correlation coefficient is defined by
\begin{equation*}
