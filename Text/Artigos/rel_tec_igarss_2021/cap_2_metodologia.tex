...
\end{equation}
onde, $\mu>0$ e $L>0$. Esta notação para a função de densidade será utilizada no método MLE com o objetivo de detectar evidências de bordas nos canais das imagens PolSAR selecionadas para esta pesquisa. 
