...
\begin{center}
    ...
    \large  \textbf{ENGENHARIA ELÉTRICA E COMPUTAÇÃO -- PPGEEC}\\
    \vspace*{0.5cm}
...
The six fusion methods were compared quantitatively e qualitatively, rescpectively, calculating the distance of the detected edges to the edges defined in the Ground Truth images and by the presence of outliers.
