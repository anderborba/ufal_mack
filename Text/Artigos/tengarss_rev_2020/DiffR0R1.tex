...
%DIF ADD FusionEvidencesPolSAR-R1.tex   Sun Jul 12 09:44:24 2020
...
\providecomand{\DIFaddend}{} %DIF PREAMBLE
...
\mathcal L\big(j&;\widehat{\mu}_I, \widehat{L}_I,\widehat{\mu}_E, \widehat{L}_E\big)= -\Bigg(
	\frac{\widehat{•}idehat{L}_\text{I}}{\widehat{\mu}_\text{I}}\sum_{k=1}^{j} z_k +
