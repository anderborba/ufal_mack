...
\begin{figure}[hbt]
	...
	\caption{Results of applying the six fusion methods to Flevoland area III}
	\label{fusion_sf_met}
\end{figure}
...
\begin{figure}[hbt]
	...
	\subfloat[PCA fusion \label{fusion_sf_met:c}]{%
		%\includegraphics[width=0.2\textwidth]{example-image-a}
		\includegraphics[width=0.32\linewidth]{sf_fus_pca_param_L_mu_25_pixel_crop}       
	}\\
	\subfloat[ROC fusion\label{fusion_sf_met:d}]{%
	...
	\subfloat[MR-SVD fusion\label{fusion_sf_met:f}]{%
		\includegraphics[width=0.32\linewidth]{sf_fus_svd_param_L_mu_25_pixel_crop}
	}
