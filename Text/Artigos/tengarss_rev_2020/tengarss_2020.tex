...
We compare the results of five fusion techniques, namely:
simple average, 
stationary wavelet transform (SWT),
principal components analysis (PCA), 
ROC statistics,
multi-resolution discrete wavelet transform (MR-DWT), and
...
\subsection{Multi-Resolution Discrete Wavelet Transform DWT}  
...
\subsection{Multi-Resolution Singular Value Decomposition SVD}

Multi-Resolution Singular Value Decomposition SVD Fusion~\cite{naidu} works similar to the DWT method. The difference consists in changing the DWT filters by the SVD filters. The SVD fusion method can be summarized for each channel, as follows:
\begin{enumerate}
