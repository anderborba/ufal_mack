...
%%% ACF Use \centering ao invés de \begin{center}, use o pacote booktabs. Localize todos os elementos flutuantes com [hbt]
\begin{table}[hbt]
	\centering
...
%%% AAB verificar o uso booktabs 
\begin{table}[hbt]
	\centering
	\caption{Características dos satélites SAR e PolSAR.}\label{cap_acf_tab02}
	\tiny
...
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{grafico_pdf_nhfc_2014_sigmahh_1.pdf}
	\caption{Distribuíção Wishart com dados simulados para o canal $I_{HH}$, (lado esquerdo da figura).}\label{cap_acf_fig02}
\endminipage\hfill
\minipage{0.5\textwidth}
  \includegraphics[width=\linewidth]{grafico_pdf_nhfc_2014_sigmahh_2.pdf}
	\caption{Distribuíção Wishart com dados simulados para o canal $I_{HH}$, (lado direito da figura).}\label{cap_acf_fig03}
\endminipage\hfill
\end{figure}
