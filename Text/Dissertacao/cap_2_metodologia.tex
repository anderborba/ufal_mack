...
\end{equation}
onde $\Gamma(L)$ denota a função gama de Euler. A equação~\eqref{pdf_inten_multilook} é a função de densidade de probabilidade que caracteriza a distribuição gama com parâmetro L.
