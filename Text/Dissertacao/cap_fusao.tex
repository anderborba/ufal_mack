...
Neste trabalho são propostos seis técnicas de fusão de evidências de bordas:
\begin{itemize} 
\item Média simples; 
...
As técnicas serão descritas nesta seção, com especial atenção para a estatística ROC. 
...
Na matriz de confusão considerada, teremos que a soma de todas as possibilidades dos resultados em uma classificação retorna o valor TP+FN+FP+TN=1.
