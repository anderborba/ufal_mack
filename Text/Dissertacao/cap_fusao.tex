...
O fluxograma para o método de fusão MR-SWT pode ser visto na figura \eqref{fig:cap_fusao_swt}. 
...
O trabalho de \cite{fawcett} mostra que o limiar ótimo ocorre na intersecção, ou perto da mesma, da curva ROC com a linha diagnóstico. Essa linha é formada conectando os pontos (P,P) e (0,1) representada pela linha vermelha na figura \eqref{fig:curva_roc}. 
