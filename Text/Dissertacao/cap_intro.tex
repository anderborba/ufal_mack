...
Esta abordagem funciona com qualquer modelo, o que o torna adequado para dados SAR e PolSAR, e tem demostrando um desempenho melhor do que outras abordagens. 
Esse algoritmo consiste em traçar raios do centroide de uma região de interesse até um ponto externo da região, para então, encontrar a evidência de borda maximizando uma função que, na proposta original, é a de máxima verossimilhança total.
...
Para não perder generalidade, optou-se pela distribuição Wishart para as observações totalmente polarimétricas, derivando para as suas distribuições, do tipo Gamma, em cada canal de intensidade. 
