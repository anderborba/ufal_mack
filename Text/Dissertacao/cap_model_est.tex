...
We obtain $(\widehat L, \widehat \mu)$, the maximum likelihood estimator (MLE) of $(L, \mu)$ based on $\bm z$, by maximizing~\eqref{eq:LogLikelihoodGamma_red} with the BFGS method implemented in the \texttt{maxLik} package~\cite{ht}.
