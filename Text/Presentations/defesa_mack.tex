...
\begin{figure}[hbt!]
   \centering
     ...
     \subfloat[GR\label{gt_flevoland_crop}]{%
       \includegraphics[width=0.453\textwidth]{gt_flevoland_crop}
     }
    \caption{FLEV-ROI-I, e GR}
    \label{roi_gt}
\end{figure}
\end{alertblock}
\end{frame}
...
\item[-] Conferência:
\begin{itemize}
\item A.\ de A.\ Borba, M.\ Marengoni, and A.\ C.\ Frery, “Fusion of Evidences for Edge Detection in PolSAR Images,” in 2019 IEEE Recent Advances in Geoscience and Remote Sensing: Technologies, Standards and Applications (TENGARSS), Kochi, Kerala, India, Oct. 2019, pp. 80–85, doi: 10.1109/TENGARSS48957.2019.8976040.
\end{itemize}
\item[-] Periódico:
\begin{itemize}
