...
\item[-] Conferência:
\begin{itemize}
\item Título do trabalho, \textit{Fusion of Evidences for Edge Detection in PolSAR Images.}
\item TENGARSS, \textit{IEEE Recent Advances in Geoscience and Remote Sensing : Technologies, Standards and
Applications.}
\end{itemize}
\item[-] Periódico:
\begin{itemize}
\item Título do trabalho, \textit{Fusion of Evidences in Intensity Channels for Edge Detection in PolSAR Images.}
\item  GRSL, \textit{IEEE Geoscience and Remote Sensing Letters.}
\end{itemize}
\end{itemize}
\end{alertblock}
\end{frame}
