...
\begin{itemize}
\item[-] Estudar a viabilidade de métodos para a fusão das evidências de bordas detectadas nos canais de intensidades hh, hv, e vv, de uma imagem PolSAR;
...
\item Forma vetorial considerando o meio recíproco (A matriz $\mathbf{S}$ é hermitiana).
